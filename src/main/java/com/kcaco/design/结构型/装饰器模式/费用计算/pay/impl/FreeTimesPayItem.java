package com.kcaco.design.结构型.装饰器模式.费用计算.pay.impl;

import com.kcaco.design.结构型.装饰器模式.费用计算.pay.AbstractPayItem;
...
public class FreeTimesPayItem extends AbstractPayItem {
    ...
    public FreeTimesPayItem(BigDecimal money, PayItemTypeEnum payItemTypeEnum, PayGroupEnum payGroupEnum) {
